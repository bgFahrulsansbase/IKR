    ...
    if (data[`skor`] == "") {
      ...
      btnMulaiKuis.addEventListener("click", () => {
        update(ref(db, `UserSiswa/${nisn}/kuis`), {
          ...
          location.href = "A-kuis-pilgan.html";
        });
      });
      ...
      <div class="card-hasil">
        ...
        <div class="btn-hasil-kuis">
          <button href="A-kuis-pilgan.html" id="ulangi-kuis" >Ulangi Kuis</button>
          <a href="../topik-b/B-pendahuluan.html"><button >Materi Selanjutnya</button></a>
        </div>
