  ...
  onValue(ref(db, `UserSiswa/${nisn}/kuis/kuis-2`), (snapshot) => {
    ...
    if (data[`skor`] == "") {
      ...
      <div class="petunjuk-kuis">
            ...
            <ol>
              <li>Kuis 2 terdiri dari 10 soal pilihan ganda.</li>
              <li>Setiap soal memiliki 10 poin.</li>
              <li>Untuk memulai kuis silahkan tekan tombol "Mulai kuis".</li>
              <li>
      ...
      btnMulaiKuis.addEventListener("click", () => {
        update(ref(db, `UserSiswa/${nisn}/kuis`), {
          ...
          location.href = "B-kuis-pilgan.html";
        });
      });
      ...
      <div class="d-md-flex text-center mt-3">
            ...
            Jawaban Benar
                <h1 class="text-success">${data[`skor`] / 10}</h1>
                <hr>    
            Jawaban Salah
        ...
        <div class="btn-hasil-kuis">
          <button id="ulangi-kuis" >Ulangi Kuis</button>
          <a href="../topik-c/C-pendahuluan.html" id="" >
          <button> Materi Selanjutnya</button></a>
        </div>
      </div>`;
      ...
      onValue(ref(db, `kkm/kuis2/`), (snapshot) => {
        ...
        <p><b>Selamat!</b> nilai Anda sangat bagus, mari pelajari materi selanjutnya</p>
        </div>
        </div>`;
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                update(ref(db, `UserSiswa/${nisn}/kuis/kuis-2`), {
                  ...
                  localStorage.setItem("kuis2Score", benar * 10);
