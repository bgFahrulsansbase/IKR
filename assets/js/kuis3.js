  ...
  onValue(ref(db, `UserSiswa/${nisn}/kuis/kuis-3`), (snapshot) => {
    ...
    if (data[`skor`] == "") {
      ...
      <div class="petunjuk-kuis">
            ...
            <ol>
              <li>Kuis 3 terdiri dari 10 soal pilihan ganda.</li>
      ...
      btnMulaiKuis.addEventListener("click", () => {
        update(ref(db, `UserSiswa/${nisn}/kuis`), {
          ...
          location.href = "C-kuis-pilgan.html";
        });
      });
      ...
      <div class="card-hasil">
        ...
        <div class="btn-hasil-kuis">
          <button href="C-kuis-pilgan.html" id="ulangi-kuis" >Ulangi Kuis</button>
          <a href="../true-evaluasi/evaluasi.html"  ><button>Mulai Evaluasi</button></a>
        </div>
      </div>`;
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                update(ref(db, `UserSiswa/${nisn}/kuis/kuis-3`), {
                  ...
                  localStorage.setItem("kuis3Score", benar * 10);
